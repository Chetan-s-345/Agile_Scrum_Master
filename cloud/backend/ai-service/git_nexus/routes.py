        ...
        try:
            ...
            async for event in sandbox_manager.run_analysis(
                ...
                if event["type"] == "progress":
                    yield f'data: {json.dumps({"type": "progress", "line": event["line"]})}\n\n'
                    ...
                    if not db_url:
                        yield f'data: {json.dumps({"type": "complete", "data": nexus_result})}\n\n'
                        return
                    ...
                    try:
                        ...
                        yield f'data: {json.dumps({"type": "complete", "data": mapped})}\n\n'
