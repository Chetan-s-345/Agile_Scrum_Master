...
If `pip.exe` reports a launcher path error after moving the workspace, use the venv Python directly: `..\..\.venv\Scripts\python.exe -m pip install -r requirements.txt`.
