...
CREATE INDEX IF NOT EXISTS idx_developers_merit_score ON developers(merit_score DESC);
CREATE INDEX IF NOT EXISTS idx_performance_history_developer ON performance_history(developer_id);
CREATE INDEX IF NOT EXISTS idx_assignment_log_task ON assignment_log(task_id);
CREATE INDEX IF NOT EXISTS idx_delay_alerts_sprint ON delay_alerts(sprint_id);
